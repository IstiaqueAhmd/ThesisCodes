...
class ScalogramDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        scalogram = np.load(file_path).transpose(2, 0, 1)  # (2, 224, 224)
...
if __name__ == '__main__':
    # Dataset setup
    train_dir = 'Data/Splitted_Data(20dB)/train'
    val_dir = 'Data/Splitted_Data(20dB)/val'
    test_dir = 'Data/Splitted_Data(20dB)/test'
