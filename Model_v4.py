...
class DualStreamCNN(nn.Module):
    def __init__(self, num_classes):
        ...
        # Define reduced AlexNet stream for single-channel input
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            patience_counter = 0
            torch.save(model.state_dict(), "modelv4.pth")
        else:
            patience_counter += 1
    ...
    # Final evaluation
    model.load_state_dict(torch.load("modelv4.pth"))
    model.eval()
    ...
    plt.tight_layout()
    plt.savefig("confusion_matrices_modelv4.png")
    plt.show()
